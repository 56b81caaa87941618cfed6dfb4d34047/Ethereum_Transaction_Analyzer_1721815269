...
Vue.component("purple_feature_grid_component_1721815270", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-1-title-container"><h4 id="feature-1-title" class="flex-1 font-medium" :class="textSecondaryStyle">Real-Time Transaction Analysis</h4></div>
            </div>
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the game with our advanced Ethereum transaction analysis tools. Get real-time insights into new transactions as they occur on the blockchain.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Gain a comprehensive understanding of each transaction with our detailed breakdown of parameters such as gas used, value transferred, and smart contract interactions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Customize your analysis with powerful filtering and sorting options. Easily identify transactions based on criteria like value, address, or contract type.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Smart Contract Monitoring</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Keep a close eye on smart contract activity with our dedicated monitoring tools. Get notified of contract deployments, function calls, and state changes.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Navigate through our intuitive and user-friendly interface, designed to make transaction analysis a breeze for both novice and experienced users.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Reliable and Secure</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">Trust our platform to provide accurate and up-to-date information, backed by robust security measures to ensure the integrity of your data.</p></div>
        </div>
    </div>`,
        data() {
            return {
