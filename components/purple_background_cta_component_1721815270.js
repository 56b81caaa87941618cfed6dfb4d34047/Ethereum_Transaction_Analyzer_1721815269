...
Vue.component("purple_background_cta_component_1721815270", {
    template: `
        ...
        <div id="section-container" class="max-w-6xl mx-auto px-4 sm:px-6 bg-white">
            <div id="content-container" class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
                ...
                <div id="content" class="max-w-3xl mx-auto text-center">
                    <div id="content-subtitle" class="flex"><div id="content-subtitle-text" class="flex-1 font-medium bg-clip-text pb-3" :class="[transparentTextStyle, contentSubtitleStyle]">Dissect Ethereum Transactions Like a Pro</div></div>
                    ...
                    <div class="flex" id="content-body-container"><p id="content-body" class="flex-1 text-lg mb-8" :class="[contentBodyStyle]">Stay ahead of the game with our cutting-edge Ethereum transaction monitoring and analysis tool. Gain valuable insights into the latest on-chain activities and make informed decisions.</p></div>
