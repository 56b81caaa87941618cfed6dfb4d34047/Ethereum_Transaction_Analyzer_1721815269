...
Vue.component("purple_header_component_1721815270", {
    template: `
            ...
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Real-Time Tracking-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Real-Time Tracking.html" :class="[textStylePrimary, hoverTextStylePrimary]">Real-Time Tracking</a></li>
                        <li><a id="Audit Tools-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Audit Tools.html" :class="[textStylePrimary, hoverTextStylePrimary]">Audit Tools</a></li>
                        <li><a id="Developer Resources-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out" href="Developer Resources.html" :class="[textStylePrimary, hoverTextStylePrimary]">Developer Resources</a></li>
                    </ul>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5" :class="signUpButtonGradient">
                            ...
                            <li><a id="mobile-Real-Time Tracking-link" class="flex font-medium text-sm py-1.5" href="Real-Time Tracking.html" :class="[textStylePrimary,hoverTextStylePrimary]">Real-Time Tracking</a></li>
                            <li><a id="mobile-Audit Tools-link" class="flex font-medium text-sm py-1.5" href="Audit Tools.html" :class="[textStylePrimary,hoverTextStylePrimary]">Audit Tools</a></li>
                            <li><a id="mobile-Developer Resources-link" class="flex font-medium text-sm py-1.5" href="Developer Resources.html" :class="[textStylePrimary,hoverTextStylePrimary]">Developer Resources</a></li>
                        </ul>
                    </nav>
